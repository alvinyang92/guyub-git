<body class="">
    <header>
        <!--desktop navigation-->
        <nav class=" lg:hidden ">
            <div class=" w-full border-b fixed top-0 bg-white z-50 ">
                <div class="flex items-center justify-between py-2 px-20 lg:px-8 sm:px-3 mx-auto max-w-8xl ">

                    <!-- logo -->
                    <a class="mr-12" href="./index.php">
                        <img src="./assets/images/guyub-green-logo.svg" alt="">
                    </a>
                    ...
                    <div class="flex items-center space-x-6 ">
                            ...
                            <div x-cloak @click.away="open = false" x-data="{ open: false }">
                                ...
                                <div class="py-5 relative ">
                                    <a @click="open = !open" class="e flex items-center justify-center space-x-2    ">
                                        ...
                                        <!-- word -->
                                        <button :class="{'text-fnb-yellow transform transition duration-200 ease-in ': open, 'transform transition duration-200 ease-in ': !open}" class="font-normal transition ease-in duration-200  " href="./irobot-home-app.php">Search
                                        </button>
                                    </a>
                                </div>

                                <!-- dropdown menu -->
                                <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-300" x-transition:enter-end="transition ease-out duration-300 " class="absolute min-w-[550px] origin-top top-[64px] rounded-md shadow-lg z-30 bg-white  ">

                                    <!--max width container-->
                                    <div class="w-full bg-white rounded-md nav-shadow px-6 py-6">
                        ...
                        <div class="relative">
                            <div x-cloak @click.away="open = false" x-data="{ open: false }">
                                ...
                                <!-- button -->
                                <div class="py-5  relative ">
                                    <a @click="open = !open" class="e flex items-center justify-center space-x-1">
                                        <!-- word -->
                                ...
                                <!-- dropdown menu -->
                                <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-300" x-transition:enter-end="transition ease-out duration-300 " class="absolute min-w-[550px]  origin-top top-[72px] rounded-md shadow-lg z-30 bg-white  ">
                                    ...
                                    <div class="w-full bg-white rounded-md nav-shadow flex justify-between  px-6 py-8">
                                        ...
                                        <div class="w-full flex flex-col justify-start space-y-3">
                                            <!-- title -->
                                            <a href="" class="relative -full  hover:text-guyub-green transition duration-200 ease-in font-semibold">Buy Property</a>

                                            <!-- item-->
                                            <a href="" class="relative w-full hover:text-guyub-green transition duration-200 ease-in">All Property for Sale</a>

                                            <!-- item-->
                                            <a href="" class="relative w-full hover:text-guyub-green transition duration-200 ease-in">Residential (Landed)</a>

                                            <!-- item-->
                                            <a href="" class="relative w-full hover:text-guyub-green transition duration-200 ease-in">Residential (Non-Landed)</a>
                        ...
                        <div class="relative">
                            <div x-cloak @click.away="open = false" x-data="{ open: false }">
                                ...
                                <!-- button -->
                                <div class="py-5  relative ">
                                    <a @click="open = !open" class=" flex items-center justify-center space-x-1">
                                        <!-- word -->
                        ...
                        <!-- | -->
                        <div class="">
                            <a href="./about.php" class="font-normal ">|</a>
                        </div>
                        ...
                        <div class="relative">
                            <div x-cloak @click.away="open = false" x-data="{ open: false }">
                                ...
                                <!-- dropdown menu -->
                                <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-300" x-transition:enter-end="transition ease-out duration-300 " class="absolute min-w-[250px]  origin-top top-[72px] rounded-md shadow-lg z-30 bg-white  ">
                        ...
                        <div class="">
                            <button class="border border-guyub-green text-guyub-green px-3  py-2  rounded font-medium">Login | Sign Up</button>
                            <!-- <a href="./about.php" class="font-normal text-white btn">Resources</a> -->
                        </div>
