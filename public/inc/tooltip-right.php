 ...
 <div class="space-y-4" x-cloak @click.away=" open=false" x-data="{ open: false }">
     ...
     <!-- dropdown menu -->
     <div x-cloak x-show="open" x-transition:enter="transition opacity-0 ease-out duration-300" x-transition:enter-end="transform origin-bottom opacity-100" class="absolute right-[70px] w-2/5 z-30 -ml-1 ">
         <!--max width container-->
         ...
         <!-- arrow -->
         <div class="absolute right-0 top-[-7px]">
             <svg class=" z-10 w-9 h-14 text-orange-500 fill-current stroke-current" width="10" height="10">
