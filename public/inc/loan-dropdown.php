 ...
 <div class="space-y-4">
     ...
     <div class=" flex " x-cloak @click.away=" open=false" x-data="{ open: false }">
         <div class="relative w-full">
             <!-- button -->
             <a @click="open = !open" class="w-full px-3 py-2 border rounded-lg  text-guyub-black space-x-1 flex justify-between items-center overflow-hidden ">
                 <!-- word -->
             ...
             <!-- dropdown menu -->
             <div x-cloak x-show="open" x-transition:enter="transition opacity-0 ease-out duration-300" x-transition:enter-end="transform origin-bottom opacity-100" class="w-full absolute rounded-md shadow-lg z-30 bg-white max-h-[250px] overflow-scroll ">
                 <!--max width container-->
